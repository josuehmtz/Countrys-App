...
//
//   const rESTCountrysResponse = Convert.toRESTCountrysResponse(json);
//
...
export class Convert {
  public static toRESTCountrysResponse(json: string): Country[] {
      return cast(JSON.parse(json), a(r("RESTCountrysResponse")));
  }

  public static rESTCountrysResponseToJson(value: Country[]): string {
      return JSON.stringify(uncast(value, a(r("RESTCountrysResponse"))), null, 2);
  }
}
